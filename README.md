...
### Проверки
- `pytest -q` — основной набор unit/integration тестов
- `make smoke` — offline smoke-check пользовательских сценариев и cards pipeline
- `make check` — полный локальный набор проверок (`pytest`, UX guard, cards-check, smoke)
